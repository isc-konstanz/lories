...
version=$(<$build_dir/debian/version)
...
cp -r $lori_dir/lib/systemd/* $build_dir/debian/
cp -r $lori_dir/lib/tmpfiles.d $build_dir/

mkdir -p $build_dir/etc
cp -r $lori_dir/logging.default.conf $build_dir/etc/logging.conf
cp -r $lori_dir/settings.default.conf $build_dir/etc/settings.conf
