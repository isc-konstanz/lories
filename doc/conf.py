...
html_theme_options = {
    "github_url": "https://github.com/isc-konstanz/lories",
    "icon_links": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/lories/",
            "icon": "fab fa-python",
        },
    ],
...
# of the sidebar.
html_logo = "_images/lories-logo.svg"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "_images/lories-favicon.ico"
