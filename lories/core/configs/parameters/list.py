...
class ListParameter(_TypedParameter):
    ...
    Usage::
        ...
        class MyConfigurator(Configurator):
            ports    = ListParameter(item_type=int, default=[1883],
                                     desc="Broker ports")
            tags     = ListParameter(item_type=str,
                                     desc="Resource tags")
            factors  = ListParameter(item_type=float, default=[0.5, 1.0],
                                     desc="Scaling factors")
