...
class Camera(_Camera):
    ...
    def configure(self, configs: Configurations) -> None:
        ...
        # Singleton child — built only when the [protection] block exists, so
        # users opt in by writing the section. Mirrors the FieldSimulation
        # has_member → cls(self, get_member) → components.add pattern and is
        # the shape a future ComponentParameter would resolve into.
