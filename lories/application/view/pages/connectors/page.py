...
import pandas as pd
from lories.application.view._dash_format import format_bytes_label, format_number
    ...
    def _build_channel(self, channel: Channel) -> dbc.AccordionItem:
        ...
        if channel.is_valid():
            ...
            if channel.type == bytes:
                ...
                # 3 significant figures, trailing zeros preserved. Reads as
                # "0.00", "0.120", "1234" — plain decimals for everyday power
                # and energy magnitudes, scientific notation only outside them.
